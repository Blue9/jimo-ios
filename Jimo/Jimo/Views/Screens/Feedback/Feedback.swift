        ...
        ScrollView {
            VStack(spacing: 0) {
                Group {
                    ...
                    Checkbox(label: "Would you like us to follow up with you through the phone number associated with your account?", textColor: .black, boxSize: 32, selected: $followUp)
